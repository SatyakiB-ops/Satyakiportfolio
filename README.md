...
Hi! I’m **Satyaki Basak**, a postgraduate student in **Economics with a specialization in Finance** at the Indian Institute of Foreign Trade, Kolkata.  
...
### MeraSafar — AI-Powered Multi-Agent Travel Planner
[Github](https://github.com/SatyakiB-ops/satyaki-techsci/tree/main/Multiagent%20AI%20model)
MeraSafar is an agentic AI system that turns a destination, a set of travel dates, and a budget into a complete, ready-to-use trip plan. Rather than asking a single language model to do everything at once, it splits trip planning into four specialized roles — the way a real travel agency would divide work across desks — and coordinates them through a central agent team built on the Agno framework. The result is delivered either through a command-line run or through a polished Streamlit web app.Trip planning is really several distinct research tasks bundled together, so MeraSafar splits it across four focused agents rather than one generic prompt: a Destination Research Agent for attractions, landmarks, and local events (with sourced, hidden-gem-inclusive results); a Budget Optimizer Agent for flights, tiered hotel options, and a full cost breakdown in comparison tables; a Weather & Climate Agent for forecasts, seasonal warnings, and packing advice; and a Local Guide Agent for food, safety, customs, and visa info. Each is an Agno Agent running gpt-4o-mini with TavilyTools() for live search and explicit formatting instructions to keep outputs grounded and consistent. A Travel Coordinator Team sits above them, delegating the query, merging their findings, and assembling one coherent itinerary with tables and a packing checklist.
![MeraSafar web app UI](https://github.com/SatyakiB-ops/Satyakiportfolio/blob/1963877c25b0b2380961e777f1d22a5d4250cc69/assets/img/merasafar.png)
